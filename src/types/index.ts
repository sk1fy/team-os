...
export interface User {
  ...
  positionIds: ID[];
  /** Прямое назначение в отдел, например для импортированного сотрудника без должности. */
  departmentIds?: ID[];
  ...
  /** Сотрудник явно активирован в рабочем графике; для владельца всегда false. */
  ...
  /** Дата и время последнего успешного входа по паролю или постоянной ссылке. */
  lastLoginAt?: ISODate;
  /**
...
export interface Position {
  ...
  name: string;
  departmentId: ID;
  /** Уровень управленческой иерархии: 5 — верхний, 1 — нижний. */
  level?: 1 | 2 | 3 | 4 | 5;
